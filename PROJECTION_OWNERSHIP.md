...
- `governance_reconciliation_projection.v1`: reconciliation posture across lifecycle, lineage, replay, continuity, projection freshness, active authority, and registry health.
